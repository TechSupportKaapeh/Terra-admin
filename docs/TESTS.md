...
El mismo día, con la poda de Tiles, uno más:
...
El 2026-09-26, con el COG multibanda (M.9.7b), uno más:

| Qué se rompió | Qué salió en rojo |
|---|---|
| `rescaleDe` ignorando la escala | `un COG multibanda pide el rango multiplicado por su escala`, `el rango negativo de NDMI también se escala` y `sin ruido de float en la URL` |
